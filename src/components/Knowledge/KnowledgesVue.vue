...
const stylingOptions = computed(() => {
  if (minimalistOption.value)
    return "bg-gradient-to-r from-purple-800 via-fuchsia-700 to-fuchsia-900";
  ...
  languages: [
    {
      ...
      name: "Javascript",
      description:
        "Conhecimento considerável da linguagem, utilizando-a com frameworks tanto de front-end quanto de back-end.",
      colors: {
        from: "#aa5500",
        to: "#cc7700",
      },
    },
    {
      ...
      name: "Typescript",
      description:
        "Conhecimento considerável da linguagem, utilizando-a com frameworks tanto de front-end quanto de back-end (incluindo tipagem).",
      colors: {
        from: "#0033CD",
        to: "#0077ab",
      },
    ...
    {
      imgLink:
        "https://storage.googleapis.com/hcode.com.br/courses/65/logo_svg5fd776bc276da.svg",
      name: "C#",
      description:
        "Conhecimento intermediário da linguagem e na plataforma .Net Core.",
      colors: {
        from: "#7100D3",
        to: "#4000D3",
      },
  ...
  frontend: [
    {
      ...
      name: "HTML5",
      description:
        "Conhecimento de diversas tags, semânticas e noções de responsividade.",
      colors: {
        from: "#FF8C00",
        to: "#FF4500",
      },
    },
    {
      ...
      name: "CSS",
      description:
        "Assim como o HTML, saber CSS é essencial. Possuo noções de Flexbox, Grid, transições, animações e design responsivo.",
      colors: {
        from: "rgb(30,70,150)",
        to: "rgb(20,20,90)",
      },
    },
    {
      ...
      name: "Vue",
      description:
        "Single File Components, Provide/Inject, Watchers, Slots, Refs, Computed, Transitions e TransitionGroup, Vue Router, Composables, Stores e Emits.",
      colors: {
        from: "rgb(0,130,0)",
        to: "rgb(0,40,0)",
      },
    },
    {
      ...
      name: "React",
      description:
        "High Order Components, Hooks (como useState, useEffect, useRef, useMemo e useCallback), ContextAPI, React Router e Redux.",
      colors: {
        from: "rgb(0,130,200)",
        to: "rgb(0,10,100)",
      },
    },
    {
      ...
      name: "Sass",
      description: "At-rules (como @mixin, @function e @include).",
      colors: {
        from: "#99228d",
        to: "#CF76A6",
      },
  ...
  backend: [
    {
      name: "NodeJS",
      description:
        "Event loop, callbacks, promises, async/await e métodos HTTP.",
      imgLink:
    ...
    },
    {
      name: "Express",
      description:
        "Requests, responses, middleware, CORS e conexão com banco de dados.",
      imgLink: "https://iconape.com/wp-content/files/ep/370863/svg/370863.svg",
      colors: {
        from: "#999",
        to: "black",
      },
    },
    {
      name: "Nest",
      description:
        "Pipes, Guards, Decorators, Controllers, Middleware, Modules, Services, CORS e conexão com banco de dados.",
      imgLink:
    ...
    },
    {
      name: ".Net Core",
      description:
        "Utilização do ASP.NET Core Web API para criação de APIs utilizando a plataforma .Net Core.",
      imgLink:
    ...
    },
    {
      ...
      description:
        "Conexão com o banco de dados, operaçoes CRUD, Migrations, Data Annotations, Fluent API, e Conventions.",
      colors: {
        from: "purple",
        to: "#4000ff",
      },
  ...
  databases: [
    {
      ...
      name: "SQL",
      description:
        "Cláusulas de seleção, atualização, inserção, deleção, Stored Procedures, Triggers, joins e aggregate functions.",
      colors: {
        from: "#0012cc",
        to: "#866",
      },
    ...
    {
      imgLink: "https://www.svgrepo.com/show/303232/mongodb-logo.svg",
      name: "MongoDB",
      description: "Schemas, collections, databases e replica set.",
      colors: {
        from: "#235601",
        to: "#543105",
      },
    ...
    {
      imgLink:
        "https://plugins.jetbrains.com/files/12820/149292/icon/pluginIcon.svg",
      name: "Redis",
      description: "Caching.",
      colors: {
        from: "#aa0000",
